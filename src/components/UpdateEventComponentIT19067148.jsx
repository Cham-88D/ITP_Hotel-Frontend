...
class UpdateEventComponentIT19067148 extends Component {
    constructor(props){
        super(props)
    ...
    updateEvent = (e) =>{
        ...
        EventServiceIT19067148.updateEvent(event, this.state.Event_Id).then( res => {
            this.notify();
...
export default UpdateEventComponentIT19067148;